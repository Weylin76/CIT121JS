...
const myInfo = {
name:'Weylin Douglas'
,photo: 'images/selfPortrait.jpg'
,favoriteFoods: ['Steak', 'Pizza', 'Wings']
...
myInfo.favoriteFoods.forEach(food => {
    let myFavFood = document.createElement('li');
    myFavFood.textContent = food;
    document.getElementById('favorite-foods').appendChild(myFavFood);
});
...
myInfo.hobbies.forEach(hobby =>{
    ...
    myhobbies.textContent = hobby;
    document.getElementById('hobbies').appendChild(myhobbies);
});
